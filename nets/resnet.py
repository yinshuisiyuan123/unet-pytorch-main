...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x       = self.conv1(x)
        x       = self.bn1(x)
        feat1   = self.relu(x)#(1, 64, 112, 112)

        x       = self.maxpool(feat1)
        feat2   = self.layer1(x)#(1, 256, 56, 56)

        feat3   = self.layer2(feat2)#(1, 512, 28, 28)
        feat4   = self.layer3(feat3)#(1, 1024, 14, 14)
        feat5   = self.layer4(feat4)#(1, 2048, 7, 7)
